...
<OPTIONS Product="Arposh New User Creation" Version="1.2">
 ...
 <Default>
  <Domain>dre.com</Domain>
  <Path>OU=Users,OU=Accounts,OU=DRG,DC=DRE,DC=COM</Path>
  <FirstName></FirstName>
  <LastName></LastName>
  <Office></Office>
  <Title></Title>
  ...
  <Company>DRG</Company>
  <Phone>928-428-7450/Phone>
  <Site>AZ</Site>
  <StreetAddress>300 E 4TH ST</StreetAddress>
  <City>Safford</City>
  <State>AZ</State>
  <PostalCode>85546</PostalCode>
  <Password>Impressive1!</Password>
 </Default>
 <Locations>
  <Location Site="AZ">
   <StreetAddress>300 E 4TH ST</StreetAddress>
