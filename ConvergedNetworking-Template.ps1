...
param (
    ...
    $ManagementNetAdapterIp = '10.10.1.6',
...
New-NetLBFOTeam –Name $TeamName –TeamMembers "1GBE1","1GBE2","10GBE1","10GBE2" –TeamingMode SwitchIndependent –LoadBalancingAlgorithm Dynamic
