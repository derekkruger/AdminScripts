...
New-VMSwitch $SwitchName –NetAdapterName "10GBE1","10GBE2","1GBE1","1GBE2" –AllowManagementOS 0 –MinimumBandwidthMode Weight -Notes "cluster, live migration, iSCSI, and VM networks."
